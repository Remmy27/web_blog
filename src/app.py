...
def user_blogs(user_id=None):
    ...
    return render_template("user_blogs.html", blogs=blogs, first_name = user.first_name)
...
def blog_posts(blog_id):
    ...
    return render_template("posts.html", posts = post, blog_title = blog.title, blog_id = blog._id)
